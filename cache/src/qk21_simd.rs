...
pub const XGK: Simd<f64,32> = Simd::from_array([-0.995657163025808080735527280689003, -0.973906528517171720077964012084452,
...
pub const WGK: Simd<f64,32> = Simd::from_array([0.011694638867371874278064396062192, 0.032558162307964727478818972459390,
...
pub const WG: Simd<f64,32> = Simd::from_array([0.0, 0.066671344308688137593568809893332, 0.0, 0.149451349150580593145776339657697,
