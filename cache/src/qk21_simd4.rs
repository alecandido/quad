...
pub const XGK: [f64;10] = [0.148874338981631210884826001129720,
...
pub const WGKODD1: Simd<f64,4> = Simd::from_array([0.011694638867371874278064396062192,
    0.054755896574351996031381300244580, 0.093125454583697605535065465083366,
    0.123491976262065851077958109831074]);



pub const WGKODD2: Simd<f64,2> = Simd::from_array([0.142775938577060080797094273138717,
...
pub fn fvec_simd(f : &dyn Fn(f64)->f64, centr : f64, hlgth : f64)
                 -> (Simd<f64,4>, Simd<f64,2>, Simd<f64,4>, f64, Simd<f64,4>, f64, Simd<f64,4>,f64){
    (Simd::from_array([f(centr + hlgth * XGK[0]), f(centr + hlgth * XGK[2]),
        f(centr + hlgth * XGK[4]), f(centr + hlgth * XGK[6])]),
     Simd::from_array([f(centr + hlgth * XGK[8]),f(centr)]),
