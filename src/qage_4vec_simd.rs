...
pub fn gt( a : &Simd<f64,4>, b : &Simd<f64,4> ) -> bool{
    for k in 0..a.lanes(){
...
mod tests {
    ...
    fn test(){
        ...
        let start = Instant::now();
        let res = qag_vec3.qintegrate(&fun2,a,b,epsabs,epsrel);
        //println!("time : {:?} ... {:?}",start.elapsed(),res);
        ...
        for k in 0..100{
            ...
            let start = Instant::now();
            let res_simd = qag_vec3.qintegrate(&fun2,a,b,epsabs,epsrel);
