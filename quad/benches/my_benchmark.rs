    ...
    for z in range{
        ...
        group.bench_with_input(BenchmarkId::new("Rgsl_qag", z), &rgsl_input, |b, &inp| {
            ...
            b.iter(|| {
                for _k in 0..z{
                    let work = IntegrationWorkspace::new(1000000);
                    let _res = work.expect("a").qag(f,inp.0,inp.1,inp.2,inp.3,inp.4,inp.5);}
                }
...
fn number_of_interval_subdivision(c: &mut Criterion) {
    ...
    for z in range{
        ...
        group.bench_with_input(BenchmarkId::new("Rgsl_qag", z), &rgsl_input, |b, &inp| {
            ...
            b.iter(|| {
                    let work = IntegrationWorkspace::new(1000000);
                    let _res = work.expect("a").qag(f,inp.0,z,inp.2,inp.3,inp.4,inp.5);}
        ...
        group.bench_with_input(BenchmarkId::new("My_qag", z), &input, |b, &inp| {
            ...
            b.iter(|| integrate(&f,inp.0,z,inp.2,inp.3,inp.4,inp.5,[0.0;0].to_vec(),inp.6));
        });
        ...
        group.bench_with_input(BenchmarkId::new("My_qag_par", z), &input, |b, &inp| {
            ...
            b.iter(|| integrate_par(&f,inp.0,z,inp.2,inp.3,inp.4,inp.5,[0.0;0].to_vec(),inp.6));
        });
    ...
    for z in range{
        group.bench_with_input(BenchmarkId::new("Rgsl_qag", z), &rgsl_input, |b, &inp| {
            ...
            b.iter(|| {
                ...
                work.expect("a").qag(f,inp.0,inp.1,inp.2,inp.3,inp.4,key)}
            );
        ...
        group.bench_with_input(BenchmarkId::new("My_qag", z), &input, |b, &inp| {
            ...
            b.iter(|| integrate(&f,inp.0,inp.1,inp.2,inp.3,z,inp.5,[0.0;0].to_vec(),inp.6));
        });
        ...
        group.bench_with_input(BenchmarkId::new("My_qag_par", z), &input, |b, &inp| {
            ...
            b.iter(|| integrate_par(&f,inp.0,inp.1,inp.2,inp.3,z,inp.5,[0.0;0].to_vec(),inp.6));
        });
